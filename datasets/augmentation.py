...
class DataAugmentationOnDetection:
    ...
    def random_bright(self, img, max_delta=0.2, p=0.5):
    ...
    def random_contrast(self, img, lower=0.8, upper=1.2, p=0.5):
        if np.random.random() < p:
...
if __name__ == '__main__':
    # 图像和标签文件夹
    image_path = r"D:\yolov11-main\datasets\images"
    label_path = r"D:\yolov11-main\datasets\labels"
    save_path = r"D:\yolov11-main\datasets\augmentation"  # 结果保存位置路径，可以是一个不存在的文件夹
    # 运行
